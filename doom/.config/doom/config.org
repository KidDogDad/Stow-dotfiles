...
** Calendar With =org-gcal=
This isn't working right now. I followed the steps from [[https://joshblais.com/blog/integrate-org-mode-google/][How to integrate org-mode and google calendar - The Universe of Joshua Blais]]. First, I had to set my default browser to Chromium (Firefox won't work). When I call =org-gcal-sync=, it takes me to the Google auth page, I sign in with my account and authorize. It prompts me for a password for Emacs to use to lock this, and I type it in. After that, I got a 404 error in Emacs, and nothing synced.

If I want to try this again, I need to re-enable =org-gcal= in my packages file.
